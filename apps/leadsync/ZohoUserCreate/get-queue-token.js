...
async function getQueueToken() {
    try {
        const config = {
            ...
            code: "1000.7d353a0ea5ce0db339c2ac60e6984364.5fb51ea9ef26e02fc4d4de39a2c3347a",
        ...
        const response = await fetch(`${config.accounts_url}/oauth/v2/token`, {
            ...
            body: new URLSearchParams({
                ...
                code: config.code,
                scope: 'zohovoice.queues.ALL,zohovoice.agents.ALL'  // Added both scopes
            })
        });
        ...
        if (data.refresh_token) {
            ...
            console.log('New tokens saved to zoho_tokens_queues.json');
        } else {
