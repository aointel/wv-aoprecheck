...
export default function UserManagement() {
  const mockUsers = [
    { id: '1', name: 'Demo producer', email: 'demo@connectnow.com', role: 'producer', status: 'Active', lastLogin: '2 hours ago' },
    { id: '2', name: 'producer Smith', email: 'smith@aoglobelife.com', role: 'producer', status: 'Active', lastLogin: '1 day ago' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground">Call producers</p>
          </CardContent>
        </Card>
