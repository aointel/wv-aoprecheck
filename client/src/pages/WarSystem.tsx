      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">producer Connect Review System</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <DemoCardsButton 
            ...
            onCardsAdded={() => {
              ...
              queryClient.invalidateQueries({ queryKey: ['/api/war/connects-for-review', user?.email] });
            }}
          />
          ...
          <CardContent>
            <div className="mb-4 flex items-center justify-between">
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Swipe cards to classify connects. Cards you've already reviewed are hidden.
              </p>
              <Button
                variant="outline"
                size="sm"
