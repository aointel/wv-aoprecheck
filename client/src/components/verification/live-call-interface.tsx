...
export function LiveCallInterface({ session, onCallComplete }: LiveCallInterfaceProps) {
  ...
  const initiateCall = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/verification/session/${session.sessionId}/start-live-call`, {
        ...
        body: JSON.stringify({
          producerPhone: verificationNumber
        })
      });
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          toast({ 
            ...
            description: "producer line connected - proceed with client verification" 
          });
        }, 3000);
      } else {
  ...
  const getStatusInfo = () => {
    switch (callStatus) {
      ...
      case 'calling':
        return { color: 'default', text: 'Calling producer Line...', icon: PhoneCall };
      case 'connected':
        return { color: 'default', text: 'producer Connected', icon: Volume2 };
      case 'completed':
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-blue-600">producer Line: {verificationNumber}</p>
          ...
          <div className="grid grid-cols-2 gap-4 p-4 border rounded-lg mb-4">
            ...
            <div>
              ...
              <div className="space-y-1 text-sm text-gray-600">
                ...
                <p>2. producer receives call with client data</p>
                <p>3. Producer Calls client at {clientPhone}</p>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  Click below to initiate a live Twilio call to the verification line. the producer will receive 
          ...
          {callStatus === 'calling' && (
            <div className="text-center py-8 bg-orange-50 rounded-lg">
              ...
              <p className="text-sm text-orange-600">producer will receive Twilio call for {clientName} verification</p>
          ...
          {callStatus === 'connected' && (
            <div className="space-y-4">
              <div className="text-center py-6 bg-green-50 rounded-lg">
                ...
                <p className="text-lg font-medium text-green-800">producer Line Connected!</p>
