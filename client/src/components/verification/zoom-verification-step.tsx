...
export const ZoomVerificationStep: React.FC<ZoomVerificationStepProps> = ({
  ...
  const handleDisclaimerAccept = () => {
    ...
    // In production, wait for actual verification completion rather than auto-timeout
    setTimeout(() => {
      setIsJoining(false);
      // Don't auto-complete - wait for actual verification status
    }, 3000);
  };
        ...
        <CardContent className="space-y-6">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-blue-800 text-sm">
              Join a secure Zoom meeting to complete your policy verification with a licensed producer.
            </p>
          </div>
