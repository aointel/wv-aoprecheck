/**
 * Connect section entry point for compartmentalized builds.
 * Connect UI - dialer, VDP, credits.
 */
...
async function main() {
  const { registerConnectRoutes } = await import("./routes-sections/routes-connect");
