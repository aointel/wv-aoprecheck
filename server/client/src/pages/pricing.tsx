...
const features = [
  ...
  },
  {
    ...
    description: "Complete agent profiles, permissions, and performance tracking"
  },
  {
    icon: BarChart3,
...
const faqs = [
  {
    ...
    answer: "Start with a 14-day free trial with full access to all features. No credit card required to begin."
  },
  {
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Choose the perfect plan for your call center. Start with a free trial and scale as you grow.
          </p>
