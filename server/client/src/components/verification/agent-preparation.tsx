...
interface AgentPreparationProps {
...
const preparationSteps = [
  ...
  },
  {
    ...
    items: [
      "Explain that an AI agent will join the call",
...
const dosDonts = {
  ...
  donts: [
    ...
    "Don't interrupt the AI agent",
    "Don't discuss policy changes during verification",
    "Don't end the call until verification is complete"
  ]
};

export function AgentPreparation({ session, onBack, onContinue }: AgentPreparationProps) {
      ...
      <CardContent className="p-6 md:p-8">
        ...
        <div className="bg-blue-50 rounded-lg p-6 mb-6">
          <div className="flex items-center mb-3">
            ...
            <h3 className="font-medium text-blue-800">About the AI Agent</h3>
          </div>
