...
export function VerificationProgress({ sessionId, onComplete, onBack }: VerificationProgressProps) {
    ...
    const initializeTwilio = async () => {
      try {
        ...
        device.on('disconnect', () => {
          ...
          // Clear monitoring
          const durationMonitor = (window as any).durationMonitor;
          if (durationMonitor) {
            clearInterval(durationMonitor);
          }
        });
  ...
  const startVerificationCall = async () => {
    ...
    try {
      // Capture client IP address and location data
    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="text-center space-y-4">
          ...
          {/* Show completion button when verification is successful */}
