...
export function CallCenterDashboard() {
  ...
  // Active calls for current agent
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Real-time call tracking and agent performance monitoring
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {overviewData.agentStats.slice(0, 5).map((agent, index) => (
                <div
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">
                        {agent.agentName || agent.agentEmail.split('@')[0]}
                      </div>
                      <div className="text-xs text-muted-foreground">
                        {agent.totalCalls} calls • {agent.totalConnects} connects
                      </div>
                    </div>
                  </div>
              ...
              {overviewData.agentStats.length === 0 && (
