...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  useEffect(() => {
    console.log('DashboardLayout: showAgentProfile state changed to:', showAgentProfile);
  }, [showAgentProfile]);

  // Only three specific emails have admin access
  const isAdmin = user?.email === "martintoma@aoglobelife.com" || 
                  user?.email === "cnsysop@aoglobelife.com" || 
                  user?.email === "chrislafond@aoglobelife.com";

  // Get routes using the same function as ConnectNowLayout
